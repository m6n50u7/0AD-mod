...
ResourceSupply.prototype.Schema =
	...
	"</optional>" +
	"<optional>" +
		"<element name='RemoveOnExhaust' a:help='whether delete the entity after finished'>" +
			"<data type='boolean'/>" +
		"</element>" +
	"</optional>" +
...
ResourceSupply.prototype.Init = function()
{
	...
	this.rem = this.template.RemoveOnExhaust != "false";
...
ResourceSupply.prototype.Change = function(change)
{
	...
	// Remove entities that have been exhausted in case is allowed.
	if (this.amount == 0 && this.rem)
